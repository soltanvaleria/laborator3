...
import com.aditya.demo.repository.BasicRepository;
...
public class BasicServiceImpl implements BasicService 
{
	...
	public Basic update(Basic basic) {
		Basic oldBasic = findById(basic.getId());
		if(oldBasic == null) {
			return null;
		}
		oldBasic.setName(basic.getName());
		return basicRepository.save(oldBasic);
	}
}
